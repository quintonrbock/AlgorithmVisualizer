 ...
 */
 ...
 public class InsertionSortVisualizer extends JPanel {
     ...
     /*
      * sort: Initiates the insertion sort algorithm on the array and visually updates
     ...
     /*
      * sleep: Handles the delay between sorting steps. It checks periodically if the
     ...
     private void sleep() {
         ...
         while (remainingDelayTime > 0) {
             ...
             // Sleep for a small interval to allow responsiveness.
             long sleepTime = Math.min(checkInterval, remainingDelayTime);
             try {
